...
{
    // Formulario para mostrar los detalles de unas patatas grandes y permitir su agregado a la cesta
    public partial class DetallePatatasGrande : Form
    {
        // Constructor del formulario
        public DetallePatatasGrande() { InitializeComponent(); }

        // Cierra el formulario de detalles
        private void pb_close_detail_Click(object sender, EventArgs e) => this.Close();

        // Agrega unas patatas grandes a la cesta con la opción de añadir queso y muestra un mensaje de éxito
        private void button1_Click(object sender, EventArgs e)
        {
            Patatas p = new Patatas(2);
